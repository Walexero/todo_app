...
const controlUpdateTodoAndTaskView = function (currentTodo = undefined) {
  console.log("the current todo ", currentTodo);
  //update UI
  ...
  console.log("ran through todo list");
...
const controlAddAndSetTodoEventListeners = function () {
  console.log("added and set todo event listener");
...
const controlAddTodo = function () {
  ...
  console.log("the eevent listener on todo vieew", eventListenersOnTodoView);
...
const controlAddTask = function (task) {
  let currentTodo;
  console.log("ran add task contro");
